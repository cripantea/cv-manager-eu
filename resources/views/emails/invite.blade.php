...
<head>
    ...
    <title>CV Manager EU — Invitation</title>
</head>
                ...
                <table width="600" cellpadding="0" cellspacing="0" style="background-color:#ffffff;border-radius:8px;overflow:hidden;box-shadow:0 2px 8px rgba(0,0,0,0.08);">
                    ...
                    <tr>
                        <td style="padding:40px;">
                            <p style="margin:0 0 16px;font-size:16px;color:#111827;">Hello <strong>{{ $user->name }}</strong>,</p>
                    ...
                    <tr>
                        <td style="padding:24px 40px;background-color:#f9fafb;border-top:1px solid #e5e7eb;">
                            <p style="margin:0;font-size:12px;color:#9ca3af;line-height:1.6;">
                                If you did not request this invitation, please ignore this email. No action is required on your part.
                            </p>
                        </td>
                    </tr>
